...
using WebApiWithSwaggerIntegration;
...
using System.Linq;
using WebApiWithSwaggerIntegration.Classes;
using Newtonsoft.Json;
using Newtonsoft.Json.Serialization;

[assembly: PreApplicationStartMethod(typeof(SwaggerConfig), "Register")]

namespace WebApiWithSwaggerIntegration
{
    public class SwaggerConfig
    {
                ...
                .EnableSwaggerUi(c =>
                    {
                        ...
                        //
                        c.CustomAsset("index", thisAssembly, "WebApiWithSwaggerIntegration.SwashbuckleHTML.index.html");
        ...
        {
            return System.String.Format(@"{0}\bin\WebApiWithSwaggerIntegration.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        }
